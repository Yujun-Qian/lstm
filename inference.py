...
for line in lines[: min(num_samples, len(lines) - 1)]:
    ...
    for char in target_text:
        if char not in target_characters:
            print("Add target character: ", char)
...
def decode_sequence(input_seq):
    ...
    while not stop_condition:
        ...
        print("Shape of output tokens:", output_tokens.shape)
...
for seq_index in range(1):
    ...
    input_seq[0, -1, input_token_index["I"]] = 1.0
    input_seq[0, -2, input_token_index[" "]] = 1.0
    input_seq[0, -3, input_token_index["l"]] = 1.0
    input_seq[0, -4, input_token_index["o"]] = 1.0
    input_seq[0, -5, input_token_index["v"]] = 1.0
    input_seq[0, -6, input_token_index["e"]] = 1.0
    input_seq[0, -7, input_token_index[" "]] = 1.0
